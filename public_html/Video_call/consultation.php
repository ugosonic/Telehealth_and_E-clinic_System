...
// Get the patient ID from the variable passed
$patient_id = isset($patient_id_variable) ? $patient_id_variable : 0;
...
if (isset($_SESSION['username'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>User not found. Please <a href='../login/login.php'>login again</a>.</p>";
    }
    $stmt->close();
}
...
<head>
    ...
    <link rel="stylesheet" href="consultation_embedded.css">
...
<body>
        ...
        <div class="profile-header custom-profile">
            <div class="profile-details">
                ...
                <div class="nav-links">
    <a href="../patient/patient_record.php?id=<?= $patient_id ?>" class="ajax-link" data-url="/my clinic/patient/patient_record.php?id=<?= $patient_id ?>">Profile</a>
    <a href="../patient/edit_record.php?id=<?= $patient_id ?>" class="ajax-link" data-url="/my clinic/patient/edit_record.php?id=<?= $patient_id ?>">Edit Record</a>
    <a href="../patient/consultation.php?id=<?= $patient_id ?>" class="ajax-link" data-url="/my clinic/patient/consultation.php?id=<?= $patient_id ?>">Consultation</a>
    <a href="../patient/medical_history.php?id=<?= $patient_id ?>" class="ajax-link" data-url="/my clinic/patient/medical_history.php?id=<?= $patient_id ?>">Medical History</a>
    <a href="../patient/prescriptions.php?id=<?= $patient_id ?>" class="ajax-link" data-url="/my clinic/patient/prescriptions.php?id=<?= $patient_id ?>">Prescriptions</a>
    <a href="../appointment_manager/book_appointment.php?id=<?= $patient_id ?>" class="ajax-link" data-url="../appointment_manager/book_appointment.php?id=<?= $patient_id ?>">Appointments</a>
</div>
        ...
        <form action="../patient/submit_consultation.php" method="post">
            ...
            <div class="section">
                ...
                <div class="plain-text"><strong>Doctor's Name:</strong> <?= $username ?></div>
            ...
            <div class="section">
                <h2>Signature</h2>
                <div class="plain-text"><strong>Doctor's Signature:</strong> <?= $username ?></div>
