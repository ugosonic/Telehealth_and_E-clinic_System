...
function getvideoConsultation($usergroup) {
    switch ($usergroup) {
        ...
        case 'Patient':
            return "../Video_call/join_session.php";
        default:
...
function getWaitingRoomLink($usergroup) {
    switch ($usergroup) {
        ...
        case 'Patient':
            return "../Waiting_room/patient_waiting_room.php";
        default:
            return "../Waiting_room/all_waiting_rooms.php";
    }
}
...
<div class="container">
    ...
    <div class="sidebar-icon">
        ...
        <a href="../patient/medical_records.php"><i class="fas fa-file-medical"></i></a>
        <a href="<?= getWaitingRoomLink($usergroup); ?>"><i class="fas fa-users"></i></a>
        <a href="../laboratory.php"><i class="fa fa-flask"></i></a>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <a href="../Laboratory/dashboard.php">
...
<div class="card" style="margin-top: 0px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <?php while ($row = $res->fetch_assoc()): ?>
                    <tr style="border-bottom: 1px solid #ddd;">
                        ...
                        <td style="padding: 8px;">
                            <a href="../messaging/view_message.php?id=<?= $row['id']; ?>">View</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
                </tbody>
    ...
    <div style="margin-top: 18px;">
        <a href="../messaging/inbox.php?filter=unread">See all unread messages</a> |
        <a href="../messaging/inbox.php">Go to Inbox</a>
    </div>
</div>
...
<div id="rescheduleModal" class="modal">
    <div class="modal-content">
        ...
        -->
        <form id="rescheduleForm" action="../appointment_manager/reschedule_appointment.php" method="post">
...
<div id="cancelModal" class="modal">
    <div class="modal-content">
        ...
        <form id="cancelForm" action="../appointment_manager/cancel_appointment.php" method="post">
