...
function getDashboardLink($usergroup) {
    switch ($usergroup) {
        ...
        case 'IT':
            return "../Dashboard/it_dashboard.php";
        case 'Doctor':
            return "../Dashboard/doctor_dashboard.php";
        case 'Nurse':
            return "../Dashboard/nurse_dashboard.php";
        case 'Lab Scientist':
            return "../Dashboard/lab_scientist_dashboard.php";
        case 'Pharmacist':
            return "../Dashboard/pharmacist_dashboard.php";
        case 'Patient':
            return "../Dashboard/patient_dashboard.php";
        default:
...
function getvideoConsultation($usergroup) {
    switch ($usergroup) {
        ...
        case 'Patient':
            return "../Video_call/join_session.php";  // Add a specific waiting room for patients if necessary
        default:
...
function getWaitingRoomLink($usergroup) {
    switch ($usergroup) {
        ...
        case 'Nurse':
            return "../Waiting_room/nurse_waiting_room.php";
        case 'Lab Scientist':
            return "../Waiting_room/laboratory_waiting_room.php";
        case 'Pharmacist':
            return "../Waiting_room/pharmacy_waiting_room.php";
        case 'Patient':
            return "../Waiting_room/patient_waiting_room.php";  // Add a specific waiting room for patients if necessary
        default:
            return "../Waiting_room/all_waiting_rooms.php";
    }
}
...
.sidebar-icon .dropdown-menu::before {
    ...
    min-width: 200px; /* Set a minimum width for better visibility */
        ...
        /* Top small containers */
        .small-containers .card {
            width: 30%;
            height: 150px;
        }

        /* Middle large containers */
        .large-containers .card {
            width: 48%;
            height: 300px;
            overflow-y: auto;
        }
...
<a class="navbar-brand" href="#"><i class="fas fa-bars" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSidebar"></i></a>
        ...
        <a href="../Laboratory/create_lab_test.php">
            <i class="fa fa-flask"></i>
            <div class="menu-item__text">Laboratory</div>
        </a>
        <a href="../pharmacy_management_system/Dashboard.php">
            <i class="fa fa-medkit"></i>
            <div class="menu-item__text">Pharmacy</div>
        </a>
        <?php if ($usergroup !== 'Patient'): ?>
            <a href="../patient/medical_records.php">
        ...
        <a href="<?= ($usergroup === 'Patient') ? '../settings/patient_account_settings.php' : '../settings/staff_account_settings.php'; ?>">
            <i class="fa fa-cog"></i>
...
function getRandomColor() {
    ...
    <div>
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item"><a href="../Laboratory/dashboard.php"><i class="fa fa-flask"></i> Laboratory</a></li>
            <li class="list-group-item"><a href="../pharmacy_management_system/Dashboard.php"><i class="fa fa-medkit"></i> Pharmacy</a></li>
            <?php if ($usergroup !== 'Patient'): ?>
            <li class="list-group-item"><a href="../patient/medical_records.php"><i class="fas fa-file-medical"></i> Medical Records</a></li>
            <li class="list-group-item"><a href="<?= getWaitingRoomLink($usergroup); ?>"><i class="fas fa-users"></i> Waiting Room</a></li>
            <li class="list-group-item"><a href="../staff_registration/registration.php"><i class="fa fa-user-plus"></i> Staff Registration</a></li>
            <?php endif; ?>
...
function updateUnreadCountBadge() {
    fetch('/fetch_unread_message_count.php') // Adjust the path if necessary
