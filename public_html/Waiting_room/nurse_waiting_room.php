...
if (!isset($_SESSION['usergroup']) || $_SESSION['usergroup'] != 'Nurse') {
...
// Fetch patients in the nurse's waiting room
$sql = "SELECT wr.waiting_id, p.patient_id, p.first_name, p.surname, wr.check_in_time 
        ...
        WHERE wr.waiting_room = 'Nurse' AND wr.status = 'Waiting' 
...
<head>
    ...
    <title>Nurse's Waiting Room</title>
    <link rel="stylesheet" href="waiting_room.css">
</head>
<body>
    <h2>Nurse's Waiting Room</h2>
    <div class="container">
        <table class="table">
            <tr>
                <th>Patient Name</th>
