...
// Check if the user is logged in and is a Lab Scientist
if (!isset($_SESSION['usergroup']) || $_SESSION['usergroup'] != 'Lab Scientist') {
...
// Fetch patients in the laboratory waiting room
$sql = "SELECT wr.waiting_id, p.patient_id, p.first_name, p.surname, wr.check_in_time 
        ...
        WHERE wr.waiting_room = 'Laboratory' AND wr.status = 'Waiting' 
...
<head>
    ...
    <title>Laboratory Waiting Room</title>
    <link rel="stylesheet" href="waiting_room.css">
</head>
<body>
    <h2>Laboratory Waiting Room</h2>
    <div class="container">
        <table class="table">
            <tr>
                <th>Patient Name</th>
